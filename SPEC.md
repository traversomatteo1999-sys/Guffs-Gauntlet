...
| **Phase 45 — UI, animation & sound overhaul** (Moxfield-inspired desktop · card art · FX layer · fuller soundscape) | 🟡 **IN PROGRESS** (specced 2026-07-04; governed by D5). **Step 1 DONE & verified (2026-07-05):** P45.1 fonts/tokens/legibility · P45.2 card art · P45.4 sound. **Step 2 next:** P45.3 FX · P45.5 desktop · P45.6 stack dock. |
...
| &nbsp;&nbsp;P45.3 Animation/FX layer decoupled from the innerHTML-rebuild render (damage numbers · life flash · tap/move motion) | ⬜ PLANNED (Step 2) |
...
| &nbsp;&nbsp;P45.5 Moxfield-style ≥1100px desktop layout (multi-pane battlefield + side rail) over the same panels | ⬜ PLANNED (Step 2) |
| &nbsp;&nbsp;P45.6 Stack popup stops occluding the board (dockable) + log legibility rework | ⬜ PLANNED (Step 2) |
