...
| **Phase 49 — Fix batch 2026-07-07** (enemy-box UI · spell/stack routing · counters on non-creatures · economy retune · **Italian i18n + flag** · campaign flow · enemy deck realism/removal · enemy coloured mana · combat/PW/siege UX · item persistence · Ash-the-Guardian ability rewrites) | ⬜ **PLANNED (specced 2026-07-07)** — the user's 30-item fix list, grounded below in `play.html`. Covers bullets 1–30; **3 already-satisfied (verify-only): #2 spell→gy · #10 resurgent timing · #13 consumable persistence** (user-confirmed no change — passives correctly expire on descend); **3 reverse earlier decisions (flagged): #16 enemy coloured mana (vs P44) · #20/21 automate enemy instants (vs P4.2/4.4) · #22 PW abilities off-stack (vs P38)**. **#15 commander tax = real-MTG +2 per command-zone cast (user-decided).** See `# PHASE 49`. |
| &nbsp;&nbsp;P49.1 Enemy-box UI: collapsible/grouped mana-modifier sub-box + ⓘ · bigger warden icons · Library Cards/Tokens default-collapsed | ⬜ planned (bullets 1·5·4) |
| &nbsp;&nbsp;P49.2 Spell/stack routing: newest-on-top render · countered player spell → graveyard · commander tax flat +2 **per cast** | ⬜ planned (bullets 2·12·15) |
...
| &nbsp;&nbsp;P49.11 Vael/Ash the Guardian: reborn at 1 HP · +1 → "Create a 1/1 Ash Soldier with haste" · −3 → graveyard exile-X + free reanimate ≤X | ⬜ planned (bullets 23·27·28) |
| &nbsp;&nbsp;P49.12 Items & cards: enemy top/bottom-N reveal shows full card info · add art to saved homebrew cards | ⬜ planned (bullets 14·17; #13 resolved — no change) |
...
# PHASE 49 — Fix batch 2026-07-07 ⬜ PLANNED
